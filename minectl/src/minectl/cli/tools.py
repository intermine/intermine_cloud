...
tools.add_command(poetry)
tools.add_command(minio)
tools.add_command(mc)
tools.add_command(nats)
tools.add_command(traefik)
tools.add_command(kind)
tools.add_command(k)
tools.add_command(helm)
tools.add_command(kstm)
tools.add_command(tf)
tools.add_command(gitea)
tools.add_command(flux)
tools.add_command(dev)
tools.add_command(argo)
